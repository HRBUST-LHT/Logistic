...
#raw Gradient Rise Method
def gradAscent(dataMatIn, classLabels):
    #transform as a numpy matrix
    #dataMatrix: [[ 1.0000000e+00 -1.7612000e-02  1.4053064e+01]...], matrix = 100*3
    #scientific notation(like1.7*10^3)
    dataMatrix = np.mat(dataMatIn)
    #labelMat: [[0]...], matrix = 100*1
    ...
    maxCycles = 500               #set cycles
    # the weight is initialized to 1, same as n: the number of columns, matrix is 3*1
    weights = np.ones((n, 1))
    # print("\nweights: \n" + str(weights))


    #begin cycle(500 times)
...
if __name__ == '__main__':
    ...
    print "\nweight:\n", weight
    # getA() means: transform a numpy matrix to a array(use .mat(): transform array to a matrix)
