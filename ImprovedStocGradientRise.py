...
#Improved Stochastic Gradient Rise Method
def improveStocGradAscent(dataMatrix, classLabels, numIter):
    ...
    for j in range(numIter):
        ...
        for i in range(m):
            ...
            weights = weights + alpha*dataMatrix[chooseOne]*error
            del(chooseOne)
            # print("\ndataIndex after delete: \n" + str(dataIndex))
...
if __name__ == '__main__':
    ...
    weight = improveStocGradAscent(np.array(dataArr), labelMat, 150)
    print "\nweight:\n", weight
    plotBestFit(weight)